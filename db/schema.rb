...
ActiveRecord::Schema.define(version: 20180403152222) do
  ...
  create_table "works_to_catalogues", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer "work_id"
    t.integer "catalogue_id"
  ...
  create_table "works_to_standard_terms", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer "work_id"
    t.integer "standard_term_id"
  ...
  create_table "works_to_standard_titles", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer "work_id"
    t.integer "standard_title_id"
